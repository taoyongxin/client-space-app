<template>
	<div>
		<div class="header bl-df-between bl-header-background">
			<div class="left">
<<<<<<< HEAD
				<router-link to="/personal"><p class="bl-title al-right">{{user.nickname}}的个人空间</p></router-link>
			</div>
...
>>>>>>> c2b68e2d8d6eef50d48f173c741f8353d8b39118
				...
				<router-link to="/notes">
					<div class="bl-row al-left">
						<img src="../assets/image/相册.png" class="icon" />
						<h2>相册</h2>
					</div>
				</router-link>
					...
					<div class="SocialContact-container bl-shadow bl-col" v-if="socialcontactistrue">
						<div class="SocialContact-card bl-col">
							<div class="bl-header-background SocialContact-card-header bl-col">
								<div class="bl-row">
									<div class="SocialContact-card-header-left bl-coll-4"><img src="../assets/image/测试1.png" class="user-avatar" /></div>
									<div class="SocialContact-card-header-center bl-col bl-coll-4">
										<div class="bl-row">
											<p>{{user.nickname}}</p>
											<i class="iconfont vip">&#xe65e;</i>
										</div>
										<div><p class="motto-font">{{user.introduction.substring(0,10)}}</p></div>
									</div>
									<div class="SocialContact-card-header-right bl-coll-4"><i class="iconfont weather">&#xe643;</i></div>
								</div>
						     <input type="text" class="socialcontact-search" placeholder="      搜索"/>
							</div>
				...
				<div @mouseleave="Setupleave" @mouseenter="SetupEnter">
					...
					<div class="SetUp-container bl-col" v-if="setupistrue">
						...
						<div class="Setup-label" :class="{ 'Setup-label-click': opinionistrue === true }" @mouseleave="OpinionLeave" @mouseenter="OpinionEnter">意见反馈</div>
					</div>
				</div>
			</div>
		</div>
